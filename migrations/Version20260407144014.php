...
final class Version20260407144014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($platform instanceof MySQLPlatform) {
            $this->addSql('CREATE TABLE ingredient (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, default_unit VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_6BAF78705E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
            $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(160) NOT NULL, preparation_time_minutes SMALLINT NOT NULL, estimated_cost NUMERIC(7, 2) NOT NULL, main_ingredient VARCHAR(80) NOT NULL, seasonality VARCHAR(16) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
            $this->addSql('CREATE TABLE weekly_plan (id INT AUTO_INCREMENT NOT NULL, week_start_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
            $this->addSql('CREATE TABLE meal_slot (id INT AUTO_INCREMENT NOT NULL, weekly_plan_id INT NOT NULL, recipe_id INT DEFAULT NULL, served_on DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', meal_type VARCHAR(10) NOT NULL, INDEX IDX_B6D0F393E0E9AE94 (weekly_plan_id), INDEX IDX_B6D0F39359D8A214 (recipe_id), PRIMARY KEY(id), CONSTRAINT FK_B6D0F393E0E9AE94 FOREIGN KEY (weekly_plan_id) REFERENCES weekly_plan (id), CONSTRAINT FK_B6D0F39359D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
            $this->addSql('CREATE TABLE recipe_ingredient (id INT AUTO_INCREMENT NOT NULL, recipe_id INT NOT NULL, ingredient_id INT NOT NULL, quantity NUMERIC(8, 2) NOT NULL, unit VARCHAR(20) NOT NULL, INDEX IDX_22D1FE1359D8A214 (recipe_id), INDEX IDX_22D1FE13933FE08C (ingredient_id), PRIMARY KEY(id), CONSTRAINT FK_22D1FE1359D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id), CONSTRAINT FK_22D1FE13933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
